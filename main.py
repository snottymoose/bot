...
FORM_CONFIG = {
    ...
    "questionnaire": {
        ...
        '1) <b>Ник</b> в игре и <b>юзернейм</b> в телеграме.\n'
        '2) <b>Имя/Прозвище/Кличка.</b>\n'
        '3) <b>Возраст.</b>\n'
        '4) <b>Внешность.</b> Текстовое описание необязательно, если прикреплены изображения.\n'
        '5) <b>Характер,</b> черты личности.\n'
        '6) <b>Биография.</b>\n'
        '7) <b>Дополнительная информация,</b> факты.\n\n'
        'Текст разрешается оформлять по-своему (в т.ч. с использованием премиум-эмодзи), однако все пункты должны быть заполнены.\n'
...
async def start(
    ...
    await message.answer(
        '<b>Вас приветствует многофункциональный бот сервера <a href="https://t.me/MLADAB0SNA">Mlada Bosna</a>!<b>\n\n'
