...
FORM_CONFIG = {
    ...
    "questionnaire": {
        ...
        'Текст разрешается оформлять по-своему (в т.ч. с использованием премиум-эмодзи), однако все пункты должны быть заполнены. Проследите за тем, чтобы ваша анкета умещалась в одно сообщение телеграма. В противном случае можно вставить ссылки на сторонние хранители информации.',
