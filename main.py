...
async def start(
    ...
    await message.answer(
        ...
        '3) <b>Анкетник:</b> регистрация лорного персонажа. Для заполнения анкеты необходимо уже являться участником сервера. Подробнее о ролевом аспекте можно узнать на соответственном <a href="https://t.me/MLADAB0SNA_chars">Mlada Bosna</a>.',
        reply_markup=menu,
